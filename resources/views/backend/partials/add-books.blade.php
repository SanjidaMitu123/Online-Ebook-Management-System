...
<form method="post" action="{{route('dashboard.createbook')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                        <label for="category_id">Select books Category 
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
  add category
                        ...
                        @foreach($clist as $category)
                            ...
                            <div class="form-group">
                                <label for="about_book">About the book:</label>
                                <input name="about_book" type="text" class="form-control" id="about_book" placeholder="Write Something About Your Books" required>
                            </div>
                            <div class="form-group">
                                <label for="book_preview">Add book Preview:</label>
                                <input name="book_preview" type="file" class="form-control" id="book_preview" required>
                            </div>
                            <div class="form-group">
                                <label for="book">Add   books:</label>
                                <input name="book" type="file" class="form-control" id="book" required>
                            </div>

                            <div class="form-group">
                                <label for="book_image">Upload Book Image:</label>
                                <input name="book_image" type="file" class="form-control" id="book_image" required>
                            </div>
