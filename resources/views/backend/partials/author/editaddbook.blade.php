...
<form  action="{{route('mybook.update',$allbook->id)}}" enctype="multipart/form-data" method="post">
                            @method('put')
                            @csrf
  ...
  add category
                        ...
                        @foreach($clist as $category)
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{$allbook->book}}"name="book" type="file" class="form-control" id="book" >
                            </div>
