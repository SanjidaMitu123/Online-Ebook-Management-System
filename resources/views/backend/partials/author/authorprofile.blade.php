                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                <div class="m-b-25"> <img style="    width: 100px; 
                                 border-radius: 100px; padding: 10px;" src="{{url('/uploads/author_picture/'.auth()->user()->image)}}" class="img-radius" alt="User-Profile-Image"> </div>
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400">{{auth()->user()-> phone_no}}</h6>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Your Library</h6>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Recent</p>
                                        <h6 class="text-muted f-w-400">Sam Disuja</h6>
